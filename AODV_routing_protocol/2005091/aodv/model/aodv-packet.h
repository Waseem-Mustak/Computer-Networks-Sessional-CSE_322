...
enum MessageType
{
    ...
    AODVTYPE_RRREQ = 5 //!< reverse route request
};
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class Rev_RreqHeader : public Header
{
  public:
    /**
     * constructor
     ...
     * \param originSeqNo the origin sequence number
     */
    Rev_RreqHeader(uint8_t flags = 0,
               uint8_t reserved = 0,
               uint8_t hopCount = 0,
               uint32_t requestID = 0,
               Ipv4Address dst = Ipv4Address(),
     ...
     * \return true if the RREQ headers are equal
     */
    bool operator==(const Rev_RreqHeader& o) const;
 ...
 * \return updated stream
 */
std::ostream& operator<<(std::ostream& os, const Rev_RreqHeader&);
